<div class="sidebar d-none d-lg-flex flex-column p-4">
    ...
    <ul class="nav nav-pills flex-column mt-4 mb-auto gap-2 text-start" id="desktop-nav">
        ...
        <li class="nav-item"><a href="#skills" class="nav-link">
                ...
                Compétences</a></li>
        <li class="nav-item"><a href="#projets" class="nav-link">
    ...
    <div class="pt-3 border-top text-center">
        ...
        <a href="https://www.linkedin.com/in/dylan-lavieille-0674003a0/" target="_blank" rel="noopener noreferrer"
        ...
        <div class="d-flex justify-content-center align-items-center gap-2 mt-2 theme-switch-container">
