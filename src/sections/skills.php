    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 card-hover card-skill <?= $skill['category'] ?>">
                    <div class="card-body">
                        <h5 class="card-title fw-bold text-primary"><?= htmlspecialchars($display_titles[$skill["category"]]) ?></h5>
